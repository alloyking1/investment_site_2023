              ...
              >
               ...
               Terms Of Service
                ...
                <p
                  ...
                  "
                >
                Crypto currency, Real Estate, Foreign Exchange, Infrastructure, Quantitative Investments, Agriculture 
                </p>
              </div>
            </div>
                     ...
                     <p class="text-body-color text-base dark:text-dark-6">
                        <ul class="p-6">
                            <li>
                                ...
                                By accessing or using our services at  {{ env('APP_NAME') }}, including our website [Website URL], you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use our services.
                            ...
                            <li>
                                <span class="text-primary mb-2 block text-lg font-semibold">
                                 ...
                                 {{ env('APP_NAME') }} provides a range of services detailed on our website. These services are for your personal and non-commercial use unless otherwise agreed in writing.
                            ...
                            <li>
                                <span class="text-primary mb-2 block text-lg font-semibold">
                                    ...
                                    To access some features of the service, you must register for an account. When you register, you must provide accurate information and keep this information up-to-date. You are responsible for maintaining the confidentiality of your account and password.
                            ...
                            <li>
                                ...
                                You may not use our service for any illegal or unauthorized purpose. Additionally, you may not engage in data mining, data harvesting, or any other similar activity in relation to our website, nor use our website to engage in any advertising or marketing.
                            ...
                            <li>
                                ...
                                All content, trademarks, service marks, and other intellectual property on the website are property of  {{ env('APP_NAME') }} or its licensors and are protected by copyright and other laws. You agree not to copy, modify, or distribute such content without our permission.
...
We may terminate or suspend your account and bar access to the service immediately, without prior notice or liability, under our sole discretion, for any reason whatsoever, including without limitation if you breach these Terms.
                            ...
                            <li>
                                <span class="text-primary mb-2 block text-lg font-semibold">
                                 ...
                                 {{ env('APP_NAME') }} shall not be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, or other intangible losses, resulting from your use of the service.

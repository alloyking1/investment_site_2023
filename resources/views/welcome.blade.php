      ...
      "
        ...
        <div class="flex flex-wrap items-center -mx-4">
            ...
            <p
              ...
              "
            >
            Crypto currency, Real Estate, Foreign Exchange, Infrastructure, Quantitative Investments, Agriculture, Active Equity, Multi Assets
            </p>
        ...
        <div class="w-full px-4">
           <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <p class="text-body-color text-base dark:text-dark-6">
                Equipped with the cutting edge features that make a 21st Century Investment Platform, We guarantee 95%
                success in all of our multiple business transactions outcomes.
                Investment and financial discipline is highly volatile and requires years of practice to master.
                Getting started with the financial market and investments can be a bit complex and risky.
                Work with us and make it easy .
                Why not invest with professionals who have
                years of experience and get good returns.
                <br>
                
                We have multiple businesses across different sectors of the economy.
     ...
     <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
           <div
              ...
              >
              <div
                 class="bg mb-8 flex h-[150px] w-[150px] items-center justify-center rounded-2xl"
                 >
                 <div class="mx-2 rounded-2xl">

                   <img class="rounded-full py-2" src="{{ asset('assets/custom_style/img/real_estate2.jpg') }}" alt="">
                 </div>
              </div>
              ...
              <p class="text-body-color dark:text-dark-6">
                            {{env('APP_NAME')}} Asset Management provides expert real estate investment services, enhancing portfolio diversification and delivering strong returns. We cover all key real estate sectors globally and locally, leveraging deep research and active investment strategies.
                            Our focus includes global trends like demographic shifts, urbanization, technology, and ESG factors, aiming to benefit clients through these themes.
              </p>
           </div>
        </div>
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
           <div
              ...
              <div
                 ...
                 >
              <div class="mx-2">
                  <img src="{{asset('assets/custom_style/img/equity2.jpg')}}" alt="" class="rounded-full py-2">
              </div>
              </div>
              <h4 class="text-dark dark:text-white mb-[14px] text-2xl font-semibold">
                ACTIVE EQUITY
              ...
              <p class="text-body-color dark:text-dark-6">
                As active equity investors, we see significant growth and income potential in equity markets, offering investors exposure to developed and emerging economies. We base our performance on thorough company research, focusing globally on understanding companies and their sectors, and creating high-conviction portfolios with our top ideas. ESG considerations are central to our approach, enhancing returns and reducing risk by integrating ESG insights into our research and decisions and actively engaging with companies on these issues.
              </p>
           </div>
        </div>
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
           <div
              ...
              <div
                 ...
                 >
              <div class="mx-2">
                  <img src="{{asset('assets/custom_style/img/agriculture.jpg')}}" alt="" class="rounded-full py-2">
              </div>
              </div>
              <h4 class="text-dark dark:text-white mb-[14px] text-2xl font-semibold">
                AGRICULTURE
              ...
              <p class="text-body-color dark:text-dark-6">
                All investments contains risk, but investing in Agriculture is not more risky
                            than other asset classes. Real assets, like income-producing Agriculture, provide a hedge
                            against inflation, and are an attractive investment for a diversified portfolio like ours.
                            There are many reasons to invest in agriculture: it is low-risk investment that keeps pace
                            with inflation and increases in value over the long-term. Agriculture is on of our strong 
                            hold.
              </p>
           </div>
        </div>
              ...
              >
                ...
                >
                  ...
                  <h2
                    ...
                    "
                  >
                  The Genesis of {{ env('APP_NAME') }}
                  </h2>
                  <p class="text-base text-body-color mb-9 leading-relaxed">
                    In the spring of 2018, two ambitious minds, Sarah Lin and Michael Torres, found themselves discussing the potential of emerging markets over a casual coffee in downtown San Francisco. Sarah, a seasoned investment banker, and Michael, a software engineer with a knack for finance, shared a
                     vision of creating an investment company that was different – one that was deeply rooted in technology and innovative investment strategies.
                  </p>
                  <a
                    href="{{ route('about') }}"
                    class="
                ...
                <div class="text-center">
                  <div class="relative inline-block z-10 ml:mr-0 mr-4">
                    <img
                      src="{{ asset('/images/about/office_space.jpg') }}"
                      alt="image"

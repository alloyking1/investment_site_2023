...
<body>
        ...
        <div class="flex w-full items-center justify-between px-4">
              ...
              <ul class="blcok lg:flex 2xl:ml-20">
                ...
                <li class="submenu-item group relative">
                  <a href="javascript:void(0)"
                    class="relative mx-8 flex items-center justify-between py-2 font-medium text-base text-dark dark:text-white group-hover:text-primary lg:mr-0 lg:ml-8 lg:inline-flex lg:py-6 lg:pl-0 lg:pr-4 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                    Pages
          ...
          <div class="justify-end pr-16 flex items-center lg:pr-0">
            <label for="themeSwitcher" class="inline-flex cursor-pointer items-center" aria-label="themeSwitcher"
              ...
              <span class="text-white block dark:hidden">
                <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- ====== Hero Section Start -->
  <div id="home" class="relative overflow-hidden bg-blue-700 pt-[120px] md:pt-[130px] lg:pt-[160px]">
    <div class="container">
  ...
  <!-- ====== About Section Start -->
  <section id="about" class="bg-gray-1 dark:bg-dark-2 pt-20 pb-8 lg:pt-[120px] lg:pb-[70px]">
    <div class="container">
  ...
  <!-- ====== FAQ Section Start -->
  <section class="relative z-20 overflow-hidden bg-white dark:bg-dark pt-20 pb-8 lg:pt-[120px] lg:pb-[50px]">
    <div class="container mx-auto">
    ...
    <div class="container mx-auto">
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
        <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
          <div class="group shadow-testimonial dark:shadow-none mb-8 rounded-xl bg-white dark:bg-dark px-5 pt-12 pb-10">
            ...
            <div class="text-center">
              ...
              <p class="text-body-color dark:text-dark-6 mb-5 text-sm">
                Marketing Expert
              </p>
              <div class="flex items-center gap-5 justify-center">
                <a href="javascript:void(0)" class="hover:text-primary text-dark-6">
            ...
            <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
              ...
              <div class="mb-8 flex w-[330px] max-w-full">
                ...
                <div>
                  ...
                  <p class="text-base text-body-color dark:text-dark-6 mt-1">
        ...
        <div class="w-full px-4 lg:w-5/12 xl:w-4/12">
          <div
            ...
            <form>
              ...
              <div class="mb-[22px]">
                <label for="phone" class="block text-sm text-body-color dark:text-dark-6 mb-4">Phone*</label>
